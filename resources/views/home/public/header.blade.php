  ...
  <div class='nav'>
    <div class="top">
     ...
     <div class="nav-right">
        <ul>
          <li>
            <a style="position:relative" href="/cart">购物车
            <span class="guo">0</span>
            </a>
          </li>
          @if(session('onlineShopHomeUserInfo.id'))
            <li><a href="/logout">退出</a><span class="gang">|</span></li>

            <li><a href="">welcome {{session('onlineShopHomeUserInfo.name')?session('onlineShopHomeUserInfo.name'):session('onlineShopHomeUserInfo.email')}} login</a><span class="gang">|</span></li>

          @else
            <li><a class="zc" href="/reg">register</a><span class="gang">|</span></li>
            <li><a class="dl"href="/login">login</a><span class="gang">|</span></li>
          @endif
        </ul>
      </div>
   </div>
