                        ...
                        @foreach($shop as $cart)
                            <tr class=" active" gcode="52770" stock="18">
                                <td width="57" class="bc_table_sel">
                                    <input type="checkbox" name="goods[]" value="{{$cart['id']}}" />
                                </td>
                                <td width="148" class="bc_table_img">
                                    <a href="/goods/{{$cart['id']}}" target="_blank">
                                        <img src="/Uploads/goods/{{$cart['goodsInfo']->img}}" alt="">
                                    </a>
                                    <div class="bc_zhezhao"></div>
                                </td>
                                <td width="257" class="bc_proname bc_name_gift">
                                    <a href="/goods/{{$cart['id']}}" target="_blank">{{$cart['goodsInfo']->title}}</a>

                                </td>
                                <td width="163"><a href="/goods/{{$cart['id']}}" target="_blank">{{$cart['goodsInfo']->info}}</a> </td>
                                <td width="152" style="position:relative;">
                                    <span class="current_price">{{$cart['goodsInfo']->price}}</span>
                                    <!--满减-->
                                </td>
                                <td width="152" text-align:center>
                                    <label class="i_box clearfix">
                                        <input class="pro_less J_minus"  money="{{$cart['goodsInfo']->price}}" ids="{{$cart['goodsInfo']->id}}" type="button" value="-" >
                                        <input class="pro_num J_input" type="text" value="{{$cart['num']}}" style="ime-mode: disabled;" >
                                        <input class="pro_add J_add" money="{{$cart['goodsInfo']->price}}" ids="{{$cart['goodsInfo']->id}}" type="button" value="+" >
                                    </label>
                                ...
                                $money=$cart['goodsInfo']->price*$cart['num'];

                                $tot+= $money;
                                ?>
                                <td width="152" id="money{{$cart['goodsInfo']->id}}" class="bc_red">{{$money}}</td>
                                <td width="117" style="text-align:left">
                                    <a href="javascript:;" style="color: #000" title="删除" onclick="deleline(this,{{$cart['goodsInfo']->id}})">删除</a>
                                    <br>
        ...
        <form>
            ...
            <script>
                ...
                $(".J_add").click(function(){
                    ...
                    $.post("/CartAdd",{id:id,"_token":"{{csrf_token()}}"},function(data){
                ...
                $(".J_minus").click(function(){
                    ...
                    $.post("/CartJian",{id:id,"_token":"{{csrf_token()}}"},function(data){
